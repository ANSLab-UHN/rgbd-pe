...
class ChannelNet(nn.Module):
    def __init__(self,
        ...
        self.first_conv = ConvBNReLU(4, input_channel, stride=2, norm_layer=norm_layer, activation_layer=activation_layer)
...
if __name__ == "__main__":
    ChannelNet((256, 256), 18).init_weights()
    model = ChannelNet((256, 256), 18)
    model.to('cuda')
