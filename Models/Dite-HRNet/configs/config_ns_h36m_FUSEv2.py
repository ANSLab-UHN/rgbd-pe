log_level = 'INFO'
load_from = '/home/morale98/scratch/Dite-HRNet/work_dirs/config_ns_final_FUSEv2/epoch_10.pth'
resume_from = None
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/annotations/newSplit_GT_train_FULL_pngs.json',
        img_prefix=f'{data_root}/ns_imgs_train_pngs/',
        data_cfg=data_cfg,
        pipeline=train_pipeline),
    val=dict(
        type='TopDownCocoDataset',
        ann_file=f'{data_root}/annotations/newSplit_GT_val_FULL_pngs.json',
